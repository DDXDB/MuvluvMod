...
namespace MuvluvMod
{
    public static class Config
    {
        ...
        public static void Initialize()
        {
            ...
            VoiceInterruption = Plugin.Config.Bind("Gerneral", "VoiceInterruption", false, "剧情中播放下一句话时是否中断当前语音");
            ...
            TranslationCDN = Plugin.Config.Bind("Translation", "CdnURL", "https://raw.githubusercontent.com/DDXDB/MGG-AGT-ZH/refs/heads/Text_Repository", "翻译加载的CDN");
